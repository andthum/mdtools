...
def get_1st_hex_face_cols(verts, r0, box, tol):
    ...
    hex_face_cols : numpy.ndarray
        ...
        hexagons per column, containing the positions of the hexagon
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help="Width of the sampling axes (in Angstrom). Should not"
             " exceed R0*sqrt(3)/2 (= a/2 with a being the lattice"
             " constant), because otherwise the axes overlap."
             " Default: R0/2."
    )
    parser.add_argument(
        '--bin-width',
    ...
    #                 axis in this script.
    # Hexagonal axis: One of the three hexgonal second-nearest neighbour
    #                 axes.  These three axes enclose angles of 0°, 60°
    #                 and 120° with the x axis, provided that the edges
    ...
    header = (
        ...
        "\n"
        "\n"
        "Nnumber density along the second-nearest neighbour axes of a\n"
        ...
        "  2 Number density along second-nearest neighbour axes with\n"
        "    60° to x axis (in 1/A^3)\n"
        "  3 Number density along second-nearest neighbour axes with\n"
        "    120° to x axis (in 1/A^3)\n"
        "  4 Number density along second-nearest neighbour axes with\n"
        "    0° to x axis (in 1/A^3)\n"
        "  5 Sum of all second-nearest neighbour axes\n"
        "\n"
        "Column number:\n"
        "{:>14d} {:>16d} {:>16d} {:>16d} {:>16d}\n"
        "Number of sampling axes:\n"
