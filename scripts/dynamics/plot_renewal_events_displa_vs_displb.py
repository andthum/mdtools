...
if __name__ == '__main__':
    ...
    with PdfPages(args.OUTFILE) as pdf:
        ...
        axis.axvline(x=np.mean(displ1),
                     color='red',
                     linestyle='--',
                     label=r'$\langle \Delta a \rangle$')
        axis.axvline(x=np.mean(displ1**2),
                     color='blue',
                     linestyle='-.',
        ...
        plt.text(x=xpos,
                 y=ypos,
                 s=r'Tot. counts: ${:>16d}$'.format(len(displ1)),
                 fontsize=fontsize)
        ypos -= 0.05
        plt.text(x=xpos,
                 y=ypos,
        ...
        plt.text(x=xpos,
                 y=ypos,
                 s=r'${:>+16.9e}$'.format(np.mean(displ1)),
                 fontsize=fontsize)
        xpos += 0.30
        plt.text(x=xpos,
                 y=ypos,
                 s=r'${:>16.9e}$'.format(np.std(displ1)),
                 fontsize=fontsize)
        xpos += 0.30
        plt.text(x=xpos,
                 y=ypos,
        ...
        plt.text(x=xpos,
                 y=ypos,
                 s=r'${:>+16.9e}$'.format(np.mean(displ2)),
                 fontsize=fontsize)
        xpos += 0.30
        plt.text(x=xpos,
                 y=ypos,
                 s=r'${:>16.9e}$'.format(np.std(displ2)),
                 fontsize=fontsize)
        xpos += 0.30
        plt.text(x=xpos,
                 y=ypos,
